...
.service('ngCart', ['$rootScope', '$window', 'ngCartItem', 'store', function ($rootScope, $window, ngCartItem, store) {
	...
	this.addItem = function (id, name, price, quantity, data) {
        ...
        this.setCouponC = function(coupon){
        	this.$cart.coupon = coupon;
        	return this.CouponC();
        };

        this.CouponC = function(){
        	if (this.getCart().items.length == 0) return 0;
...
mainApp1.controller('thumb-ctrl', function($scope, $http) {
	...
	$http({
		method : "GET",
		url : "http://test.alliancegifting.com/admin/index.php/book/cards",
	...
	// $http({
	// 	method : "GET",
	// 	url : "http://test.alliancegifting.com/admin/index.php/book/prices",
	// }).then(function(response) {
...
mainApp1.controller('view-cards', ['$scope', '$http', '$sce','$routeParams','$rootScope', function($scope, $http,$sce,$routeParams,$rootScope) {	
	...
	$scope.fn1 = function() {
		$http({
			method : "GET",
			url : "http://test.alliancegifting.com/admin/index.php/book/card/"+id+"",
		}).then(function(response) {
			$scope.showLoader = true;
...
mainApp1.controller('view-cards-sub',function($scope, $http) {
	$scope.submitreply = function(parentid,cardid) {
		...
		$http({
			method: 'POST',
			url:  'http://test.alliancegifting.com/admin/index.php/book/reply',
			data: {				
...
mainApp1.controller('view-cards-sub-comment',function($scope, $http) {
	$scope.submitcomment = function(cardid) {
		...
		$http({
			method: 'POST',
			url:  'http://test.alliancegifting.com/admin/index.php/book/comment',
			data: {				
				'card_id': $scope.cardId,
				'parent_comment_id': '0',
				'comment':$scope.commenting,
...
mainApp1.controller('cart-test', function($scope, $http) {
	$scope.cart = function() {
		$http({
			method : "POST",
			url : "http://test.alliancegifting.com/gateway/pay.php",
			data : {
...
mainApp1.controller('myCtrl', ['$scope', '$http', 'ngCart',
	function($scope, $http, ngCart) {
		...
		$scope.addCoupon = function() {
			$http({
				method : "POST",
				url : "http://test.alliancegifting.com/admin/index.php/book/coupon",
				data : {
				...
				if(response.status != 400){
					if(response.data != null){
						if(ngCart.totalCost() > 1000){
							$scope.Coupon = response.data.discount;
							ngCart.setCouponC($scope.Coupon);
							$scope.cartCoupon = "success"
						}else{
							$scope.cartError = "failed"
						}						
					}
					else{
						$scope.noCoupon = "failed"
					}
				}
			});	
		}
...
mainApp1.controller("employeecontroller", ['$scope', '$http', 'ngCart','$route',
	function($scope, $http, ngCart,$route) {
		$scope.insertdata = function() {
			$http({
				method : "POST",
				url : "http://test.alliancegifting.com/admin/index.php/book/contact_form",
				data : {
...
mainApp1.controller('userCtrl', ['$scope', '$http',
	function($scope, $http) {
		$scope.upload = function() {
			...
			$http({
				method : 'post',
				url : 'http://test.alliancegifting.com/admin/index.php/book/do_uploads',
				data : fd,
				headers : {
...
mainApp1.controller('adminctrl', ['$scope', '$http', '$cookies',
	function($scope, $http, $window, $cookies) {
		$scope.login = function() {
			$http({
				method : 'POST',
				url : 'http://test.alliancegifting.com/admin/index.php/auth/login',
				data : {
...
mainApp1.controller('StarCtrl', ['$scope','$http','$window', function ($scope,$http,$window) {
	...
	$scope.sendRate = function(card_id){
		...
		$http({
			method: 'POST',
			url:  'http://test.alliancegifting.com/admin/index.php/book/review',
			data: {
				'card_id': $scope.cardid,
