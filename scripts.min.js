...
mainApp1.controller('thumb-ctrl', function($scope, $http) {
	...
	$http({
		method : "GET",
		url : "http://alliancegifting.com/admin/index.php/book/cards",
	...
	// $http({
	// 	method : "GET",
	// 	url : "http://alliancegifting.com/admin/index.php/book/prices",
	// }).then(function(response) {
...
mainApp1.controller('view-cards', ['$scope', '$http', '$sce','$routeParams','$rootScope', function($scope, $http,$sce,$routeParams,$rootScope) {	
	...
	$scope.fn1 = function() {
		$http({
			method : "GET",
			url : "http://alliancegifting.com/admin/index.php/book/card/"+id+"",
		}).then(function(response) {
			$scope.showLoader = true;
...
mainApp1.controller('view-cards-sub',function($scope, $http) {
	$scope.submitreply = function(parentid,cardid) {
		...
		$http({
			method: 'POST',
			url:  'http://alliancegifting.com/admin/index.php/book/reply',
			data: {				
...
mainApp1.controller('view-cards-sub-comment',function($scope, $http) {
	$scope.submitcomment = function(cardid) {
		...
		$http({
			method: 'POST',
			url:  'http://alliancegifting.com/admin/index.php/book/comment',
			data: {				
				'card_id': $scope.cardId,
				'parent_comment_id': '0',
				'comment':$scope.commenting,
...
mainApp1.controller('cart-test', function($scope, $http) {
	$scope.cart = function() {
		$http({
			method : "POST",
			url : "http://alliancegifting.com/gateway/pay.php",
			data : {
...
mainApp1.controller('myCtrl', ['$scope', '$http', 'ngCart',
	function($scope, $http, ngCart) {
		...
		$scope.addCoupon = function() {
			$http({
				method : "POST",
				url : "http://alliancegifting.com/admin/index.php/book/coupon",
				data : {
...
mainApp1.controller("employeecontroller", ['$scope', '$http', 'ngCart','$route',
	function($scope, $http, ngCart,$route) {
		$scope.insertdata = function() {
			$http({
				method : "POST",
				url : "http://alliancegifting.com/admin/index.php/book/contact_form",
				data : {
...
mainApp1.controller('userCtrl', ['$scope', '$http',
	function($scope, $http) {
		$scope.upload = function() {
			...
			$http({
				method : 'post',
				url : 'http://alliancegifting.com/admin/index.php/book/do_uploads',
				data : fd,
				headers : {
...
mainApp1.controller('adminctrl', ['$scope', '$http', '$cookies',
	function($scope, $http, $window, $cookies) {
		$scope.login = function() {
			$http({
				method : 'POST',
				url : 'http://alliancegifting.com/admin/index.php/auth/login',
				data : {
...
mainApp1.controller('StarCtrl', ['$scope','$http','$window', function ($scope,$http,$window) {
	...
	$scope.sendRate = function(card_id){
		...
		$http({
			method: 'POST',
			url:  'http://alliancegifting.com/admin/index.php/book/review',
			data: {
				'card_id': $scope.cardid,
